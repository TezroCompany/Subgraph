...
export class PancakePair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class PancakePair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class PancakePair extends ethereum.SmartContract {
  static bind(address: Address): PancakePair {
    return new PancakePair("PancakePair", address);
  }
  ...
  burn(to: Address): PancakePair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new PancakePair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<PancakePair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new PancakePair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): PancakePair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new PancakePair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<PancakePair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PancakePair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
